---
title: "EmotetAnalysis Part 1: Unpacking"
author: Player-V
...
![CFF-Explorer1](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Hex-View/1.PNG){: width="700" height="400" }
...
![CFF-Explorer3](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Hex-View/3.PNG){: width="700" height="600" }
...
![Die1](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Die/1.PNG){: width="700" height="300" }
...
![IDA1](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/IDA/1.PNG){: width="700" height="300" }

Click on `Imports` to reveal all the functions used by the binary.

![IDA2](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/IDA/2.PNG){: width="700" height="300" }
...
![IDA3](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/IDA/3.PNG){: width="700" height="300" }
...
![XDBG1](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/1.PNG){: width="700" height="300" }
...
![XDBG2](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/2.PNG){: width="700" height="300" }

Xdbg will keep running untill it hit the breakpoint, after  click two times on `Execute till run`. 

![XDBG3](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/3.PNG){: width="700" height="300" }
...
![XDBG4](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/4.PNG){: width="700" height="300" }
...
![XDBG4](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/6.PNG){: width="700" height="300" }
...
![XDBG4](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/7.PNG){: width="700" height="300" }

Right click on dump windows and `Follow in memory map`.

![XDBG4](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/8.PNG){: width="700" height="300" }

Another right click on the address of the unpacked binary then `Dump memory to file`.

![XDBG4](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Xdbg/9.PNG){: width="700" height="300" }
...
![XDBG4](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Fixing/1.PNG){: width="700" height="300" }

Drag your unpacked sample to `LordPe` and it will be fixed automatically.

![XDBG4](https://pl-v.github.io/plv//assets/[Emotet](https://www.malwarebytes.com/emotet)-part1/Fixing/2.PNG){: width="700" height="300" }
